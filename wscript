...
def build(bld):
    ...
    module.source = [
         ...
         'model/algorithms/pensieve-client.cc',
         'model/algorithms/mpc-client.cc',
         'model/algorithms/mpcfast-client.cc',
         'model/algorithms/bb-client.cc',
...
#        'helper/dash-helper.cc',
    ...
    headers.source = [
         ...
         'model/algorithms/pensieve-client.h',
         'model/algorithms/mpc-client.h',
         'model/algorithms/mpcfast-client.h',
         'model/algorithms/bb-client.h',
