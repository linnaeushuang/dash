...
class ActorNetwork(object):
    ...
    of all actions.
    """
    def __init__(self, sess, state_dim, action_dim, learning_rate,s_len):

        # s_len param is for maintain old network
        self.s_len = s_len
    ...
    def create_actor_network(self):
        with tf.variable_scope('actor'):
            ...
            split_2 = tflearn.conv_1d(inputs[:, 2:3, -self.s_len:], 128, 4, activation='relu')
            split_3 = tflearn.conv_1d(inputs[:, 3:4, -self.s_len:], 128, 4, activation='relu')
            ...
            otherAgentData = tflearn.conv_1d(inputs[:,5:6,:], 128, 2, strides=2, activation='relu')
            ...
            merge_net = tflearn.merge([split_0, split_1, split_2_flat, split_3_flat, split_4_flat, split_5, otherAgentData_flat], 'concat')
...
class CriticNetwork(object):
    ...
    """
    def __init__(self, sess, state_dim, learning_rate,s_len):
